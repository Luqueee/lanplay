...
// IDD-LAB deliberately publishes one mode. More modes belong to the product
// driver only after the 1080p120 path is measured end to end.
static const struct IndirectSampleMonitor::SampleMonitorMode s_SampleDefaultModes[] =
{
    { 1920, 1080, 120 },
};

// Static sample EDIDs remain solely for the unused descriptor parser callback.
...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"LanPlay IDD-LAB";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"LanPlay";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"1080p120 laboratory display";
...
void IndirectDeviceContext::FinishInit(UINT ConnectorIndex)
{
    ...
    // Descriptor-less by design: the only monitor mode is supplied by
    // IddSampleMonitorGetDefaultModes and intersects the target mode below.
